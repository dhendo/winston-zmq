...
var path = require('path'), vows = require('vows'), assert = require('assert'), winston = require('winston'), helpers = require('../node_modules/winston/test/helpers.js'), Zmq = require('../lib/winston-zmq').Zmq;
require('should');
...
var config = require('./fixtures/test-config');
